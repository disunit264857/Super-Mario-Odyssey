...
import com.disunit.supermarioodyssey.scene.SceneNode;
...
public class BinaryModelParser {
  ...
  public static SceneNode parseModel(Context ctx, String base, String url) {
    BufferedReader reader = null;
    SceneNode parent = new SceneNode(new GameObject());
    try {
      reader =
          new BufferedReader(
              new InputStreamReader(ctx.getAssets().open("models/" + base + url), "UTF-8"));
      String line = "";
      while ((line = reader.readLine()) != null) {
        ...
        //object.parent = parent.gameObject;
        //object.transform.rx = 90;
    ...
    parent.gameObject.mesh.updateBuffer();
    return parent;
  }
