...
public class AdditionalHealthMeter extends UI {
...
private float gap = 2f;
  ...
  public AdditionalHealthMeter(int w, int h) {
    super(w,h);
    bw = w;
    bh = h;
    healthB = 0;
    ...
    hpPaint.setStrokeWidth(bw*0.12f);
    hpPaint.setARGB(255,51,255,255);
    
    emptyPaint = new Paint();
    emptyPaint.setStyle(Paint.Style.STROKE);
    emptyPaint.setAntiAlias(true);
    emptyPaint.setStrokeWidth(bw*0.12f);
    ...
    backgroundPaint.setARGB(255,50,50,50);
  ...
  float angle = 120*(healthB+(health-healthB)*clampedDelta/500f);
    ...
    canvas.drawArc(bw*0.1f,bh*0.1f,bw*0.9f,bh*0.9f,90,angle,false,hpPaint);
    canvas.drawArc(bw*0.1f,bh*0.1f,bw*0.9f,bh*0.9f,90+angle,360-angle,false,emptyPaint);
    ...
    canvas.drawCircle(bw*0.5f,bh*0.5f,bw*0.46f,backgroundPaint);
